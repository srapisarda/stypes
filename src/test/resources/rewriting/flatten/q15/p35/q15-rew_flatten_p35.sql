WITH p28 AS (SELECT s_0.x AS X0, r_1.y AS X1
     ...
     p1 AS (SELECT p19_0.X0 AS X0, p2_4.X1 AS X1
            FROM p19 AS p19_0
                     INNER JOIN p40 AS p40_1 ON p19_0.X1 = p40_1.X1
                     INNER JOIN b AS b_2 ON p19_0.X1 = b_2.x
                     INNER JOIN r AS r_3 ON p40_1.X0 = r_3.x
                     INNER JOIN p2 AS p2_4 ON r_3.y = p2_4.X0
            UNION
            (SELECT p19_0.X0 AS X0, p2_4.X1 AS X1
             FROM p19 AS p19_0
                      INNER JOIN r AS r_1 ON p19_0.X1 = r_1.x
                      INNER JOIN p43 AS p43_2 ON r_1.y = p43_2.X1
                      INNER JOIN r AS r_3 ON p43_2.X0 = r_3.x
                      INNER JOIN p2 AS p2_4 ON r_3.y = p2_4.X0)
            UNION
            (SELECT r_0.x AS X0, p2_5.X1 AS X1
             FROM r AS r_0
                      INNER JOIN r AS r_1 ON r_0.y = r_1.x
                      INNER JOIN p43 AS p43_2 ON r_1.y = p43_2.X1
                      INNER JOIN a AS a_3 ON r_1.y = a_3.x
                      INNER JOIN r AS r_4 ON p43_2.X0 = r_4.x
                      INNER JOIN p2 AS p2_5 ON r_4.y = p2_5.X0)
            UNION
            (SELECT p19_0.X0 AS X0, s_3.x AS X1
             FROM p19 AS p19_0
                      INNER JOIN p40 AS p40_1 ON p19_0.X1 = p40_1.X1
                      INNER JOIN b AS b_2 ON p19_0.X1 = b_2.x
                      INNER JOIN s AS s_3 ON p40_1.X0 = s_3.y
                      INNER JOIN b AS b_4 ON p40_1.X0 = b_4.x)
            UNION
            (SELECT p19_0.X0 AS X0, s_3.x AS X1
             FROM p19 AS p19_0
                      INNER JOIN r AS r_1 ON p19_0.X1 = r_1.x
                      INNER JOIN p43 AS p43_2 ON r_1.y = p43_2.X1
                      INNER JOIN s AS s_3 ON p43_2.X0 = s_3.y
                      INNER JOIN b AS b_4 ON p43_2.X0 = b_4.x)
            UNION
            (SELECT r_0.x AS X0, s_4.x AS X1
             FROM r AS r_0
                      INNER JOIN r AS r_1 ON r_0.y = r_1.x
                      INNER JOIN p43 AS p43_2 ON r_1.y = p43_2.X1
                      INNER JOIN a AS a_3 ON r_1.y = a_3.x
                      INNER JOIN s AS s_4 ON p43_2.X0 = s_4.y
                      INNER JOIN b AS b_5 ON p43_2.X0 = b_5.x)
            UNION
