     ...
     p35 AS (SELECT p19_0.X0 AS X0, p40_1.X0 AS X1
             ...
             (SELECT r_0.x AS X0, p43_2.X0 AS X1
              FROM r AS r_0
                       ...
                       INNER JOIN p43 AS p43_2 ON r_1.y = p43_2.X1
                       INNER JOIN a AS a_3 ON r_1.y = a_3.x)),
     p1 AS (SELECT p35_0.X0 AS X0, p14_4.X1 AS X1
            FROM p35 AS p35_0
                     INNER JOIN r AS r_1 ON p35_0.X1 = r_1.x
                     INNER JOIN p5 AS p5_2 ON r_1.y = p5_2.X1
                     INNER JOIN r AS r_3 ON p5_2.X0 = r_3.x
                     INNER JOIN p14 AS p14_4 ON r_3.y = p14_4.X0
            UNION
            (SELECT p35_0.X0 AS X0, p14_3.X1 AS X1
             FROM p35 AS p35_0
                      INNER JOIN r AS r_1 ON p35_0.X1 = r_1.x
                      INNER JOIN r AS r_2 ON r_1.y = r_2.x
                      INNER JOIN p14 AS p14_3 ON r_2.y = p14_3.X0
                      INNER JOIN a AS a_4 ON r_2.y = a_4.x)
            UNION
            ...
            UNION
            (SELECT p3_0.X0 AS X0, p14_4.X1 AS X1
             FROM p3 AS p3_0
                      INNER JOIN p5 AS p5_1 ON p3_0.X1 = p5_1.X1
                      INNER JOIN a AS a_2 ON p3_0.X1 = a_2.x
                      INNER JOIN r AS r_3 ON p5_1.X0 = r_3.x
                      INNER JOIN p14 AS p14_4 ON r_3.y = p14_4.X0)
            UNION
            (SELECT p3_0.X0 AS X0, p14_3.X1 AS X1
             FROM p3 AS p3_0
                      INNER JOIN r AS r_1 ON p3_0.X1 = r_1.x
                      INNER JOIN a AS a_2 ON p3_0.X1 = a_2.x
                      INNER JOIN p14 AS p14_3 ON r_1.y = p14_3.X0
                      INNER JOIN a AS a_4 ON r_1.y = a_4.x))
