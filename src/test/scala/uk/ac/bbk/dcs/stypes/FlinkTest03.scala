...
/**
  ...
  */
class FlinkTest03 extends FunSpec {

  private val pathToBenchmarkNDL_SQL = "src/main/resources/benchmark/Lines"
...
//  private val a = env.readTextFile(s"$pathToBenchmarkNDL_SQL/data/csv/5.ttl-A.csv").map(stringMapper)
//  private val b: DataSet[(String, String)] = env.readTextFile(s"$pathToBenchmarkNDL_SQL/data/csv/${num}.ttl-B.csv").map(stringMapper)
//  private val r: DataSet[(String, String)] = env.readTextFile(s"$pathToBenchmarkNDL_SQL/data/csv/${num}.ttl-R.csv").map(stringMapper)
//  private val s: DataSet[(String, String)] = env.readTextFile(s"$pathToBenchmarkNDL_SQL/data/csv/${num}.ttl-S.csv").map(stringMapper)
